...
class Instruction0 extends Group {
    constructor(parent) {
        ...
        var instruction = new TextGeometry("Press SPACE to Begin", {
            font: font,
            size: 250,
            height: 8,
            curveSegments: 12,
        ...
        instrMesh.position.set(-0.12,-0.04,-0.08);
        instrMesh.scale.multiplyScalar(0.00007);
